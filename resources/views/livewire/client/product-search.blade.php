<form
    ...
    <div class="relative">
        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            <x-icons.magnifying-glass class="size-5 text-gray-800" />
        </div>
        <input
            wire:model.live.debounce.250ms="q"
            type="search"
            id="search"
               class="block w-full p-4 ps-10 text-gray-900 text-sm outline-0 rounded-lg backdrop-blur-3xl bg-white/30 "
    ...
    @if($this->products)
        <div class="backdrop-blur-3xl bg-white/30 absolute text-gray-900 z-10 top-20 w-full rounded-md h-96 overflow-x-scroll">
