            ...
            <div>
                <div x-data="{ open: false }" @mouseleave="open = false">
                    <button
                        ...
                        class="flex gap-2 font-bold text-lg items-center" @mouseover="open = true">
                        مرکز دانلود
                        <x-icons.chevron-down   class="size-6"/>
                    </button>
                    <div class="absolute top-8 pt-10 w-80"
                         x-show="open"
                         ...
                         style="display: none;">
                        <div class="bg-gradient-to-bl from-sky-400/80 to-sky-400/30 text-gray-950  rounded-tl-4xl rounded-br-4xl p-4">
                            <div class="space-y-2">
                                <div>
                                    <a class="flex gap-2 items-center" href="{{route('client.applications')}}">
                                        <x-icons.code-xml class="size-6"/>
                                        دانلود نرم افزار
                                    </a>
                                </div>
                                <div>
                                    <a class="flex gap-2 items-center" href="{{route('client.price-list')}}">
                                        <x-icons.list class="size-6"/>
                                        دانلود لیست قیمت
                                    </a>
                                </div>
